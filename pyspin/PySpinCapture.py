...
# adapted from
# https://github.com/PacktPublishing/OpenCV-4-for-Secret-Agents-Second-Edition/blob/master/Chapter008/PySpinCapture.py
...
if __name__ == "__main__":
    ...
    # print number of cameras available
    print('Number of cameras available is {}'.format(getNumCameras()))

    # create obj
    print('Initializing connection to cam0')
    index = 0
    roi = (0,0,100,200)
    ps = PySpinCapture(index, roi, isMonochrome=True)
